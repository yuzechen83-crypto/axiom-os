...
from axiom_os.layers.clifford_nn import CliffordLinear as CliffordLinearCustom, CliffordActivation
from axiom_os.layers.clifford_transformer import CliffordTransformerSoftShell
...
class RCLNLayer(nn.Module):
    ...
    def __init__(
        ...
        if use_learned_perturbation_gate and hippocampus is not None:
            from axiom_os.layers.perturbation_gate import LearnablePerturbationGate
